...
<template>
  <q-form ref="formRef" @submit.prevent="save">
    <q-input
      ...
      aria-required="true"
    ></q-input>
    <q-input v-model="localAccount.institution" label="Institution" outlined dense></q-input>
    <q-checkbox v-if="showPersonalOption" v-model="isPersonalAccount" label="Personal Account (not shared with family)" dense></q-checkbox>
    <q-input
    ...
    <div class="q-mt-lg">
      ...
      <q-btn color="grey" flat @click="cancel" class="q-ml-sm"> Cancel </q-btn>
    </div>
  </q-form>
</template>
