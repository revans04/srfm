...
import { withinDateWindow, isDuplicate, link, unlink } from '../src/composables/useTransactions.js';
// @ts-ignore explicit .js import for Node after compilation
...
test('isDuplicate', () => {
    ...
    const t1 = base;
    const t2 = { ...base, id: '2', merchant: 'Starbucks Store #123' };
    const t3 = { ...base, id: '3', merchant: 'Local Cafe' };
