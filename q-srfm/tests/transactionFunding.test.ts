...
import type { BudgetCategory, Goal } from '../src/types.js';
...
function makeGoal(overrides: Partial<Goal> & { id: string; name: string }): Goal {
  return {
    ...
    spentToDate: 0,
    status: 'in_progress',
    createdAt: { seconds: 0, nanoseconds: 0 } as unknown as Goal['createdAt'],
    updatedAt: { seconds: 0, nanoseconds: 0 } as unknown as Goal['updatedAt'],
    entityId: 'e-1',
    ...overrides,
  };
}
